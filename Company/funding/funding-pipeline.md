...
Pre-product / very early stage programs only. Updated 2026-05-25.
Both founders are current Berkeley undergrads — all programs below confirmed eligible (or flagged).

---

## Application Roadmap

Work through these in order. Non-dilutive and Berkeley-native first, then rolling VCs, then batch deadlines.

### Now — Rolling, no deadline (apply this week)
- [ ] **LSEC Venture Grant** — $100K non-dilutive R&D grant; Berkeley academic teams only; apply anytime
- [ ] **NSF I-Corps** — ~$40K customer discovery grant; rolling; pre-product is the point; strengthens SBIR later
- [ ] **IndieBio / SOSV SF** — rolling applications; research-stage bio is core thesis
- [ ] **Afore Capital** — rolling via Afore Alpha; no graduation requirement; 10-min cold apply
- [ ] **NFX Signal** — cold apply takes 10 min; top agtech pre-seed list

### May–June 2026
- [x] **a16z Speedrun SR007** — deadline was May 17, 2026 (check if SR008 opens)
- [ ] **NSF SBIR Phase I** — up to $305K non-dilutive; "plant protection" and "biological technologies" subtopics
- [ ] **USDA SBIR Phase I (NIFA)** — up to $175K; "biological pest control delivery mechanisms" listed priority

### July–August 2026
- [ ] **Berkeley SkyDeck Batch 23** — apps open July; $200K for 7.5%; Berkeley students eligible
- [ ] **Mayfield AI Garage** (via SkyDeck) — AI-focused cohort with Mayfield VC; current Berkeley students eligible
- [ ] **Free Ventures Fall cycle** — ~Aug; zero equity; explicitly accepts undergrads; requires Cal founder
- [ ] **Startup@Berkeley** — ~Aug; non-dilutive; campus resources + mentorship

### September–October 2026
- [ ] **YC W27 — Early Decision** — apply fall senior year; get funded now, join summer batch after graduation; designed for this exact situation
- [ ] **Nucleate Activator (Berkeley)** — ~Oct; company formation program; apply before you have anything
- [ ] **Cyclotron Road / Activate** — ~Oct; $100K + stipend; 2-year embedded at LBL; IP retained; research-stage

### Ongoing — VC outreach (warm intro preferred)
- [ ] **Fifty Years** — pre-seed/seed; deep tech + climate + synbio; 72 PhD founders in portfolio; SF-based
- [ ] **Breakout Ventures** — ~$350K convertible; "too early for traditional VCs" thesis
- [ ] **Cavallo Ventures** — explicitly cited backing "peptide-based biopesticides"; closest portfolio match
- [ ] **Acre Venture Partners** — $500K–$1.5M; agrifoodtech-focused; $140M Fund III; likes AI/ML in ag
- [ ] **AgFunder** — $500K–$5M; $170M AUM; explicitly backs biologicals
- [ ] **Boost VC** — $500K pre-seed; backs deep tech + biotech; low-process
- [ ] **Wireframe Ventures** — agtech specialist; pre-seed

### 2027 cycle
- [ ] **AgLaunch365** — $100K for 10%; Regenerative Biologicals track is direct fit; mid-2026 apps for 2027
- [ ] **Haas Trione Fund** — $5K; small but non-dilutive, low-effort for Berkeley students; ~Fall 2026

### Pipeline for later (build warm intros now)
- **a16z Bio + Health** — $700M fund; not a first call at pre-seed; get in via IndieBio/SkyDeck alumni network
- **YC regular track** — apply every cycle until in
